...
# Save multinomial confusion matrix + accuracy
readr::write_csv(
...
# Save the plotted probabilities dataset
readr::write_csv(
  ref_plot_df_key,
...
# Save RF confusion matrix + accuracy
readr::write_csv(
