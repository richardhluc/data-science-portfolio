...
OVERVIEW: End-to-end analysis of California census housing data to support property valuation, investment analysis, and lending risk
assessment. The project combines exploratory analysis, feature engineering, and tree-based machine learning to model median house values 
